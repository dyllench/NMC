...
export default function LowerLimbCompressionGarmentPage() {
  return (
    <>
      <Header detail title="Lower Limb Compression Garment" />
      <main className="mx-auto w-full max-w-screen-md bg-white pb-6">
        ...
        <section className="px-7 pt-5 text-center">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            <a href="https://wa.me/8618902221129" className="flex h-11 items-center justify-center gap-3 rounded-lg bg-novamedix-whatsapp-green text-base font-bold text-white shadow-soft">
              <Icon name="whatsapp" className="h-5 w-5" /> Get Quote on WhatsApp
            </a>
        ...
        <section className="mx-7 mt-4 rounded-card border border-novamedix-border bg-white p-5 shadow-soft">
          <div className="grid grid-cols-[52px_1fr] gap-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-navy">Product Overview</h2>
        ...
        <section className="mx-7 mt-3 rounded-card border border-novamedix-border bg-white p-4 shadow-soft">
          <h2 className="text-xl font-bold text-navy">Key Features</h2>
        ...
        <section className="mx-7 mt-3 rounded-card border border-novamedix-border bg-white p-4 text-center shadow-soft">
          <h2 className="text-left text-xl font-bold text-navy">Simple Custom Order</h2>
          ...
          <a href="https://wa.me/8618902221129" className="mx-auto mt-3 flex h-8 max-w-72 items-center justify-center gap-2 rounded-md bg-novamedix-teal text-sm font-bold text-white">
            <Icon name="headset" className="h-4 w-4" /> Ask for Custom Support
          </a>
        </section>

        <section className="mx-7 mt-3 rounded-card border border-novamedix-border bg-white p-4 shadow-soft">
          <h2 className="text-xl font-bold text-navy">Order Information</h2>
        ...
        <section className="mx-7 mt-4 grid items-center gap-4 rounded-card bg-[linear-gradient(135deg,#0b66dd,#0058d6)] p-6 text-white shadow-card sm:grid-cols-[auto_1fr_260px]">
          ...
          <div className="grid gap-2">
            <a href="https://wa.me/8618902221129" className="flex h-10 items-center justify-center gap-2 rounded-md bg-white text-base font-bold text-[#087d3e]">
              <Icon name="whatsapp" className="h-5 w-5" /> WhatsApp Inquiry
            </a>
            <a href="mailto:info@novamedixcustom.com" className="flex h-10 items-center justify-center gap-2 rounded-md bg-white text-base font-bold text-novamedix-blue">
              <Icon name="mail" className="h-5 w-5" /> Ask for Catalog
            </a>
          </div>
        </section>
      </main>
      <Footer />
      <StickyWhatsAppButton secondary />
    </>
  );
}
